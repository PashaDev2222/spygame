...
const WORD_CATEGORIES = {
  'Русские стримеры': ['мармок','эдисон','брейнмапс','литвин','егорик','вилсаком','фрост','куплинов','винди31','фиксай','глент','познаватель','ледидиана','ванзай','холдик','алексбойко','домер','ивангай','иеногай','румфактори','хаймен','софиядельмонстро','гинсука','стрей228','братишкинофф','эвелон','т2х2','стинтик','артас','джесус','шадоукекв','рофланебало','никифн','лехапавс','ексаил'],
  ...
  'Персонажи': ['гумбол','бентен','спайдермен','бетмен','айронмен','халк','тор','локи','веном','дэдпул','шрек','спанчбоб','патрик','скубиду','том','джерри','миккимаус','сквиртвар','джиминейтрон','Майкл джордан','Хабиб нурмагамодов','снепдог','роналдно','бойцовский клуб','джиминейтрон'],
  'Политики': ['путин','зеленский','байден','трамп','мадуро'],
  ...
  'Соцсети': ['tiktok','instagram','youtube','twitch','приложениие макс','фейсбук','телеграм'],
  'Игры': ['roblox','fortnite','csgo','dota2','valorant','Dayz','rust','Maffia'],
